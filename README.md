...
[![版本](https://img.shields.io/badge/版本-v0.3.11-blue)](#版本历史) [![平台](https://img.shields.io/badge/平台-HarmonyOS%20NEXT-black)](#) [![架构](https://img.shields.io/badge/架构-原生ArkTS-green)](#架构概览)
...
$HDC -t <serial> install -r ZhihuLite-HM-v0.3.11-signed.hap
```
